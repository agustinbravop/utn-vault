En el [[Ajustamiento Lineal]], el _coeficiente de correlación lineal_ $r$ permite medir de forma directa el **grado de relación lineal** entre dos variables $X_i$ e $Y_i$.
