Recordando la [[Función de Transferencia]] $F(s)$ de un sistema $Y(s)=F(s)\cdot X(s)$, sea $x(t)=\delta(t)$ la _función impulso unitario_, tal que la respuesta del sistema está determinada por:
