_Unified Modelling Language_ (UML) es un lenguaje de de [[Modelado de los Sistemas|modelado]] para **visualizar**, **especificar**, **construir**, y **documentar**, artefactos de un software.
