Un **registro** es un conjunto de [[Biestables]] que funcionan como una unidad. Cada celda almacena un bit de información. Un registro de $n$ bits tiene $n$ flip-flops y puede almacenar $n$ bits de información.
